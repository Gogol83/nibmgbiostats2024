...
- Hypertension
- Uterine instability
- Premature labours during pregnancy
- Number of physician visits

# Run a model with child's birth weight as response, smoking status as explanatory variable, and race, premature labour and physician visits as covariates
...
```{r}
#Step1
#lm_multip1 <- lm(bwt2 ~ as.factor(smoke) + as.factor(race) + as.factor(ptl) + as.factor(ftv) + lwt2 +
 #                  ht + , data = birthwt_modat)
